...
db.define_table('emp_skill',
				db.Field('EmployeeId', 'string', required=True),
				db.Field('priskill', 'integer', required=True),
				db.Field('secskill', 'integer', required=True),
				db.Field('expskill', 'integer', required=True),
				db.Field('learnskill', 'integer', required=True),
                migrate='emp_skill.table')

db.define_table('skill_table',
                db.Field('skill_desc', 'string', required=True),
                migrate='skill_table.table')


db.define_table('team_eval_tab',
				db.Field('EmployeeId', 'string', required=True),
				db.Field('HumanCharacter', 'integer', required=True),
				db.Field('Interpersonal', 'integer', required=True),
				db.Field('BuildingTalent', 'integer', required=True),
				db.Field('Leadership', 'integer', required=True),
				db.Field('Communication' , 'integer', required=True),
				db.Field('JobPerformance', 'integer', required=True),
				db.Field('MutualUnderstanding', 'integer', required=True),
				db.Field('Knowledge', 'integer', required=True),
				db.Field('toverall', 'integer', required=True),
				db.Field('suggested', 'string', required=True),
				migrate='team_eval_tab.table')
				
db.team_eval_tab.EmployeeId.requires=IS_NOT_EMPTY()
	
db.define_table('emp_hist_tab',
				db.Field('EmployeeId', 'string', required=True),
				db.Field('edate', 'date', required = True),
				db.Field('self_overall', 'integer', required=True),
				db.Field('team_overall', 'integer', required=True),
				migrate='emp_hist_tab.table')
